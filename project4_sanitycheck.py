...
#   "project4_sanitycheck.py".
# * There is a module named "project4.py" in the same directory.
...
def start_process() -> TextProcess:
    module_path = pathlib.Path.cwd() / 'project4_re.py'

    if not module_path.exists() or not module_path.is_file():
        print_labeled_output(
            'ERROR',
            'Cannot find an executable "project4re.py" file in this directory.',
